 ...
 */
public class MedicoDetailActivity extends AppCompatActivity  implements ViewInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putInt(MedicoDetailFragment.ARG_ITEM_ID, getIntent().getIntExtra(MedicoDetailFragment.ARG_ITEM_ID,0));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, MedicoListActivity.class));
            return true;
        }
